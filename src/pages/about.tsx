            ...
            <div className="container mx-auto px-4 py-2">
                ...
                <div className="mb-8">
                    <p className="mb-4 text-gray-700 leading-relaxed">
                        ...
                        соответствующим
                        исламским традициям. Наши программы включают хадж, умру, а также образовательные и культурные
                        поездки по святым
                        местам.
                    </p>
                    <p className="mb-4 text-gray-700 leading-relaxed">
                        Мы работаем с опытными гидами, предоставляем качественное сопровождение и
                        заботимся о каждом участнике тура. Наша цель — не просто путешествие, а духовное обогащение и
                        новые
                        знания о религии и культуре.
                    </p>
