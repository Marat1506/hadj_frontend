            ...
            {attractions.map((item) => (
              ...
              >
                <div className="relative h-44 w-full overflow-hidden">
                  ...
                  />
                  <div className="text-white absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-4">
                    <h3 className="text-lg  drop-shadow-lg">{item.title}</h3>
                  </div>
                </div>
                <div className="px-5 p-3">
                  <h3 className="text-lg  drop-shadow-lg line-clamp-4">{item.description}</h3>
                </div>
              </div>
            ))}
          </div>
