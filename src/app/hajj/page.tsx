        ...
        <>
            ...
            <div className="min-h-screen bg-white flex flex-col pb-16">
                <div className="container mx-auto px-4 py-2">
                    ...
                    {/* Sticky Search Panel */}
                    <div className="sticky top-[100px] z-40 bg-white py-4 -mx-4 px-4 sm:min-h-[60vh] flex items-center justify-center">
                        ...
                        <div className="mt-8">
                            {tours.length === 0 ? (
                                <div className="text-center py-12">
                                    <p className="text-gray-500 text-lg">Нет доступных туров</p>
                                </div>
                            ) : (
